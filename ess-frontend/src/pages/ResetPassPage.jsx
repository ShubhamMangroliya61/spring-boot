...
function ResetPassPage() {
    ...
    const { authFetch, displayAlert, showAlert, logoutUser  ,userRedirect} = useGlobalContext();
  ...
  return (
    ...
    <div className="text" style={{marginTop:100}}>
    <div className="mt-32 text-white bg-slate-800 w-[30%] m-auto flex justify-center flex-col items-center rounded-lg">
      ...
      <h3 className="my-5 font-semibold text-xl">Change Password</h3>
