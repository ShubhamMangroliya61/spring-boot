...
function CounterCard({ countHeading, count, bg }) {
  return (
    <div
      className={`${
        bg == "red"
          ? "bg-red-400 text-red-800 font-semibold duration-300 hover:shadow-[0_5px_40px_5px_rgba(100,0,0,0.7)]"
          : bg == "green"
          ? "bg-green-600 text-green-800 font-semibold duration-300 hover:shadow-[0_5px_40px_5px_rgba(0,100,0,0.7)]"
          : bg == "blue"
          ? "bg-blue-400 text-blue-800 font-semibold duration-300 hover:shadow-[0_5px_40px_5px_rgba(0,0,70,0.5)]"
          : "bg-gray-600 text-gray-800 font-semibold duration-300 hover:shadow-[0_5px_40px_5px_rgba(33,33,33,0.7)]"
